...
{
    public partial class ViewNhanVienReport : Form
    {
        public ViewNhanVienReport()
        {
            InitializeComponent();
        }

        private void ViewNhanVienReport_Load(object sender, EventArgs e)
        {
            ReportDocument cryRpt = new ReportDocument();
            cryRpt.Load(@"D:\download\BTL_LTHSK_G21\BanMayTinh\NhanVienReport.rpt");

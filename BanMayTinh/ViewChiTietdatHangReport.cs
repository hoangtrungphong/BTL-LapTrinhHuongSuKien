...
{
    public partial class ViewChiTietdatHangReport : Form
    {
        public ViewChiTietdatHangReport()
        {
            InitializeComponent();
        }

        private void ViewChiTietdatHang_Load(object sender, EventArgs e)
        {
            ReportDocument cryRpt = new ReportDocument();
            cryRpt.Load(@"D:\download\BTL_LTHSK_G21\BanMayTinh\ChiTietDatHangReport.rpt");
